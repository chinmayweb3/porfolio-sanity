...
const HeroSection = () => {
  return (
    <section className="w-full h-full pt-[150px] pb-[75px] flex items-center contain-in-section">
      {/* <div className="w-full flex justify-center items-center gap-[50px]"> */}
      <div className="w-full grid grid-cols-[1fr_1.45fr] gap-[40px] items-center">
        <div className="flex-grow aspect-[1/1.3] ">
          {/* <Image
